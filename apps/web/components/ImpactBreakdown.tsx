    ...
    <div className="space-y-10">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <h3 className="font-heading text-xs tracking-[0.2em] uppercase text-text-secondary flex items-center gap-1">
            Confidence
            <InfoTooltip
              id="tip-confidence"
              content="How much data backs your profile (50\u2013100%). Lower activity or limited diversity reduces confidence. Reflects data availability, not developer quality."
            />
          </h3>
