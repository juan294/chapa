...
export function ledgerFixture(options: { accepted?: boolean; occurredAt?: string } = {}): EngineeringLedgerSnapshot {
  ...
  return { ownerId: "owner", references: [{ ownerId: "owner", referenceId: "ref:1", artifactUri: "https://private.example.org/result", artifactRevision: "sha", observedAt: "2026-09-01T00:00:00Z", retention: "until_owner_withdrawal", expiresAt: null }],
