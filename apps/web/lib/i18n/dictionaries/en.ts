...
export const en: Translations = {
  ...
  studio: {
    ...
    categories: {
      ...
      heatmapAnimation: { label: 'Heatmap Animation', options: { 'fade-in': 'Fade In', diagonal: 'Diagonal Wave', ripple: 'Center Ripple', scatter: 'Random Scatter', cascade: 'Column Cascade', waterfall: 'Row Waterfall' }, descriptions: { 'fade-in': 'Uniform gentle fade', diagonal: 'Top-left to bottom-right', ripple: 'Expanding from center', scatter: 'Random appearance order', cascade: 'Column by column reveal', waterfall: 'Row by row reveal' } },
      interaction: { label: 'Interaction', options: { static: 'Static', 'tilt-3d': '3D Tilt', holographic: 'Holographic' }, descriptions: { static: 'No mouse interaction', 'tilt-3d': 'Perspective tilt on hover', holographic: 'Rainbow overlay on hover' } },
      statsDisplay: { label: 'Stats Display', options: { static: 'Static', 'animated-ease': 'Smooth Count', 'animated-spring': 'Spring Count' }, descriptions: { static: 'Plain numbers', 'animated-ease': 'Eased counting animation', 'animated-spring': 'Bouncy spring animation' } },
      ...
      celebration: { label: 'Celebration', options: { none: 'None', confetti: 'Confetti' }, descriptions: { none: 'No celebration effect', confetti: 'Burst of confetti on load' } },
    },
    commands: {
