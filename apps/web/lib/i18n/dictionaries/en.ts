...
export const en: Translations = {
  ...
  studio: {
    ...
    categories: {
      ...
      palette: { label: 'Color Palette', options: { jade: 'Jade', indigo: 'Indigo Night', amber: 'Amber Forge', crimson: 'Crimson', mono: 'Monochrome' }, descriptions: { jade: 'Chapa default', indigo: 'Violet-blue on deep navy', amber: 'Warm gold on charcoal', crimson: 'Rose on oxblood', mono: 'Neutral grays' } },
    },
    commands: {
