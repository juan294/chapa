...
.holo-card:hover {
  border-color: rgba(27, 208, 147, 0.25);
  box-shadow: 0 0 40px rgba(27, 208, 147, 0.06);
}
.holo-overlay {
  position: absolute;
  inset: 0;
...
.holo-amber {
  background: linear-gradient(var(--holo-angle, 115deg), transparent 20%, rgba(27, 208, 147, 0.3) 36%, rgba(157,143,255,0.3) 42%, rgba(255,255,255,0.2) 48%, rgba(157,143,255,0.3) 54%, rgba(94,79,204,0.3) 60%, transparent 80%);
  background-size: 200% 200%;
}
.holo-rainbow {
