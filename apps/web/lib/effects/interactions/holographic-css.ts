...
.holo-amber {
  background: linear-gradient(var(--holo-angle, 115deg), transparent 20%, rgba(139,92,246,0.3) 36%, rgba(157,143,255,0.3) 42%, rgba(255,255,255,0.2) 48%, rgba(157,143,255,0.3) 54%, rgba(94,79,204,0.3) 60%, transparent 80%);
  background-size: 200% 200%;
}
.holo-rainbow {
