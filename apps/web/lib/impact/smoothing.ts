...
export function calculateTrendV7(
  receipt: Pick<import("@chapa/shared").PublicScoringReceipt, "policyVersion" | "revisionId" | "window" | "core" | "action">,
  previous: import("@chapa/shared").TrendAnchor | null,
): import("@chapa/shared").TrendObservation {
