      ...
      <div className="relative mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mb-12">
          <div className="rounded-[3px] border border-stroke bg-card p-4">
            <div className="aspect-[1200/630] w-full animate-pulse rounded-[3px] bg-amber/[0.06]" />
          </div>
        </div>
        ...
        <div className="mb-12">
          <div className="rounded-[3px] border border-stroke bg-card p-8 space-y-6">
            <div className="h-4 w-32 animate-pulse rounded bg-amber/10" />
            <div className="space-y-2">
              <div className="h-4 w-20 animate-pulse rounded bg-amber/[0.06]" />
              <div className="h-12 w-full animate-pulse rounded-[3px] bg-amber/[0.04]" />
            </div>
            <div className="space-y-2">
        ...
        <div className="flex items-center gap-4">
          <div className="h-11 w-32 animate-pulse rounded-[3px] bg-amber/10" />
