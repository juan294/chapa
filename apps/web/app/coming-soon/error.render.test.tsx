...
describe("coming-soon error.tsx render", () => {
  ...
  it("reports the error to /api/telemetry with the coming-soon-error source", async () => {
    const { default: ErrorPage } = await import("./error");
    render(<ErrorPage error={new Error("coming-soon boundary boom")} reset={vi.fn()} />);
    ...
    expect(body).toMatchObject({
      ...
      source: "coming-soon-error",
      message: "coming-soon boundary boom",
    });
  });
});
