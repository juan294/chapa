...
describe("[locale]/privacy error.tsx render", () => {
  ...
  it("reports the error to /api/telemetry with the privacy-error source", async () => {
    const { default: ErrorPage } = await import("./error");
    render(<ErrorPage error={new Error("privacy boundary boom")} reset={vi.fn()} />);
    ...
    expect(body).toMatchObject({
      ...
      source: "privacy-error",
      message: "privacy boundary boom",
    });
  });
});
