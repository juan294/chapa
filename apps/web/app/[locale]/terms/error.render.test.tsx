...
describe("[locale]/terms error.tsx render", () => {
  ...
  it("reports the error to /api/telemetry with the terms-error source", async () => {
    const { default: ErrorPage } = await import("./error");
    render(<ErrorPage error={new Error("terms boundary boom")} reset={vi.fn()} />);
