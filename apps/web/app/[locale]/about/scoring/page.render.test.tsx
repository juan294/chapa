...
vi.mock("@/lib/i18n/server", () => ({
  getServerT: vi.fn().mockReturnValue((key: string) => {
    ...
    const map: Record<string, any> = {
      ...
      "about.scoring.breadthIntro": "A project becomes eligible after work on three distinct dates.",
      ...
      "about.scoring.tiersTableRows": [
        ["Emerging", "0 – 29.99", "Getting started, or a light activity period"],
        ["Solid", "30 – 69.99", "Active contribution across the window"],
        ["High", "70 – 84.99", "Strong evidence across multiple dimensions"],
        ["Elite", "85 – 100", "Exceptional breadth and depth of recorded contribution"],
      ],
      "about.scoring.sectionReceipts": "Receipts you can replay",
      "about.scoring.receiptsIntro1Prefix": "Every scored revision issues an ",
