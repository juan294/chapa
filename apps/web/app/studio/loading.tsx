  ...
  return (
    <main id="main-content" className="min-h-screen bg-bg" role="status" aria-label={t("aria.loading") as string}>
      ...
      <div className="fixed top-0 z-50 w-full border-b border-stroke bg-bg">
        <div className="mx-auto flex min-h-[68px] max-w-7xl items-center justify-between px-6 py-3">
      ...
      <div className="flex flex-col pt-[69px]">
        {/* Stage skeleton */}
        <div className="border-b border-stroke px-3 py-4 sm:px-6 sm:py-6">
          <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
            ...
            <div className="h-11 w-48 animate-pulse rounded-[3px] bg-amber/[0.06]" />
          </div>
          <div className="flex flex-col items-center gap-4 rounded-[3px] border border-forest-line bg-forest p-4 sm:p-6">
            <div className="aspect-[1200/630] w-[min(720px,100%)] animate-pulse rounded-[3px] bg-forest-card" />
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(min(100%,460px),1fr))]">
          <div className="space-y-3 border-r border-b border-stroke p-4">
            ...
            <div className="h-10 w-full animate-pulse rounded-[3px] bg-amber/[0.04]" />
            <div className="h-32 w-full animate-pulse rounded-[3px] bg-amber/[0.04]" />
          </div>
          <div className="flex flex-col gap-3 border-b border-stroke bg-card p-4">
            ...
            <div className="h-11 w-full animate-pulse rounded-[3px] border border-stroke bg-bg" />
            <div className="h-11 w-full animate-pulse rounded-[3px] bg-amber/10" />
          </div>
        </div>
      </div>
