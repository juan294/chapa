...
export default async function EmergingPage({ searchParams }: { searchParams: Promise<Record<string, string>> }) {
  return <ArchetypePage archetypeKey="emerging" searchParams={searchParams} />;
}
