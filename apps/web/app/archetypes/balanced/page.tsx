...
export default async function BalancedPage({ searchParams }: { searchParams: Promise<Record<string, string>> }) {
  return <ArchetypePage archetypeKey="balanced" searchParams={searchParams} />;
}
