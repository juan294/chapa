        ...
        <article className="animate-fade-in-up">
          ...
          <div className="pl-4 border-l border-stroke space-y-8">
            ...
            <div className="space-y-6 text-text-secondary text-sm leading-relaxed">
              ...
              <p>
                The Balanced archetype triggers when all four dimensions (Delivery, Quality,
              ...
              <div className="space-y-2">
                <div className="flex flex-col sm:flex-row gap-1 sm:gap-4">
                  ...
                  <span className="text-text-secondary text-sm">All four dimensions closely matched &mdash; no single spike or valley.</span>
                </div>
                <div className="flex flex-col sm:flex-row gap-1 sm:gap-4">
                  <span className="text-amber font-heading text-sm shrink-0 sm:w-36">REQUIREMENT</span>
                  <span className="text-text-secondary text-sm">Collectively strong &mdash; high average across Delivery, Quality, Consistency, and Breadth.</span>
                </div>
              </div>
