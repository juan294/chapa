...
describe("AdminStatsCards — render tests", () => {
  ...
  describe("tier count values", () => {
    ...
    it("falls back to 0 for missing tier counts", () => {
      render(<AdminStatsCards totalUsers={5} pageUsers={5} tierCounts={{}} />);
  ...
  describe("percentage detail", () => {
    it("shows page-scoped detail for each tier when pageUsers > 0", () => {
      render(<AdminStatsCards {...defaultProps} />);
      expect(screen.getByText("10 of 25 on this page")).toBeDefined();
      expect(screen.getByText("30 of 25 on this page")).toBeDefined();
      expect(screen.getByText("40 of 25 on this page")).toBeDefined();
      expect(screen.getByText("20 of 25 on this page")).toBeDefined();
    });

    it("does not show page detail when pageUsers is 0", () => {
      render(
        <AdminStatsCards
          totalUsers={0}
          pageUsers={0}
    ...
    it("shows raw page counts instead of whole-dataset percentages", () => {
      render(
        <AdminStatsCards
          totalUsers={3}
          pageUsers={3}
      ...
      expect(screen.getAllByText("1 of 3 on this page").length).toBe(3);
    });
  });
