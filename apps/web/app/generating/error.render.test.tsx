...
describe("generating error.tsx render", () => {
  ...
  it("reports the error to /api/telemetry with the generating-error source", async () => {
    const { default: ErrorPage } = await import("./error");
    render(<ErrorPage error={new Error("generating boundary boom")} reset={vi.fn()} />);
    ...
    expect(body).toMatchObject({
      ...
      message: "generating boundary boom",
    });
  });
});
