...
- **Impact v4 Profile**: A composite developer impact score (0-100) based on four independent dimensions — Building, Quality, Consistency, and Breadth — computed from 12 months of public GitHub activity.
- **Four Dimensions**: Building measures shipping (PRs merged, issues closed). Quality measures code review quality. Consistency measures sustained contributions over time. Breadth measures cross-project influence.
