...
The email-patch workflow is philosophically incompatible with PR-based metrics. Building/Quality/Breadth dimensions would need complete reimagining. Tiny user base doesn't justify the effort.
