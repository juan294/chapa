...
The bottom of every page has a terminal input bar. Type `/` to see available commands. Press Enter to execute.
...
| `Cmd+K` / `Ctrl+K` | Creator Studio (anywhere) | Focus the terminal input |
