Every finding from the scoring audit is required before relaunch. This epic tracks 20 implementation tasks across 15 phases, covering F01–F53. No item belongs in a later release.

**Status:** independently reviewed implementation proposal; implementation awaits approval of the completed plan. The user approved the four fixed core dimensions, separate optional Craft, attributable outcome evidence, and no penalty for AI/tool/report choices. Numeric parameters and missing-evidence ranges below are concrete proposals to approve with the plan, not already validated scientific constants.

**Baseline:** local develop at c1ce31cbf5969ee400c4cf232d67cf7dc1b1de0d. Existing locally fixed #1287 and #1294 are regression dependencies, not duplicate implementation tasks. Local plan: docs/plans/2026-09-05-scoring-relaunch.md; audit: docs/research/2026-09-05-scoring-mathematics-and-validity-audit.md. These docs are currently local; this issue contains the complete normative policy so workers are not blocked on unpublished links.

## Worker and release rules

Use GPT-6 Astra agents only. Establish S01 contracts/schema first; phases 2–7 can run independently in isolated worktrees with exclusive file ownership. Other phases integrate in dependency order. All tasks are launch blockers, with local tests and independent review required. Stop after each phase unless explicitly authorized to continue. No pushes, PRs, Vercel previews, remote CI experiments, production migration/recompute/deployment, automated emails or reviewer recruitment are authorized by these tickets. Future publication must inspect triggers and avoid previews; production actions require explicit authorization. Issue creation/update has no hosted build trigger in the inspected workflows.

## Task checklist

- [ ] S01 — #1296 — Freeze the v7 scoring policy and versioned evidence contracts (phase 1)
- [ ] S02 — #1297 — Collect correctly attributed GitHub events across the scoring window (phase 2)
- [ ] S03 — #1298 — Correct GitLab event semantics, date filters and partial-data handling (phase 3)
- [ ] S04 — #1299 — Correct Bitbucket attribution, event dates and nested pagination (phase 4)
- [ ] S05 — #1300 — Correct Codeberg activity units, contributed-repository discovery and event windows (phase 5)
- [ ] S06 — #1301 — Aggregate event evidence with correct pooled ratios, medians and deduplication (phase 6)
- [ ] S07 — #1302 — Age supplemental evidence correctly and migrate the upload contract (phase 8)
- [ ] S08 — #1303 — Replace productivity-based corruption guards with source-coverage integrity (phase 8)
- [ ] S09 — #1304 — Implement the fixed core scoring policy and AI-neutral fairness invariants (phase 9)
- [ ] S10 — #1305 — Make Craft an optional evidence-based AI engineering profile (phase 7)
- [ ] S11 — #1306 — Implement attributable outcome and engineering-practice evidence (phase 10)
- [ ] S12 — #1307 — Provide immutable score receipts and an independent offline calculator (phase 11)
- [ ] S13 — #1308 — Persist replayable snapshots and correct trend smoothing (phase 11)
- [ ] S14 — #1309 — Verify the complete issued receipt without overstating authenticity (phase 11)
- [ ] S15 — #1310 — Materialize one scoring receipt across APIs, badges and simulations (phase 12)
- [ ] S16 — #1311 — Render the fixed core, separate Craft and exact evidence explanations (phase 13)
- [ ] S17 — #1312 — Publish accurate bilingual methodology, claims and worked examples (phase 13)
- [ ] S18 — #1313 — Validate mathematical invariants, fairness and outcome evidence before relaunch (phase 14)
- [ ] S19 — #1314 — Rehearse version migration, cache transition and transparent score changes locally (phase 15)
- [ ] S20 — #1315 — Close every scoring relaunch requirement and prepare the release handoff (phase 15)

## Complete normative policy

# Scoring relaunch policy — v7 proposal

Status: concrete policy for implementation, subject to approval of the completed plan. The user explicitly approved four fixed core dimensions, optional separate Craft, and no penalty for AI usage, report disclosure or tool choice. Missing coverage uses the recommended explicit range policy; no midpoint is invented.
...
This is a fully specified implementation proposal. If tests/pilot invalidate the policy, revise and review the policy before completing S18; do not waive the failed requirement or defer it past relaunch.


## Exhaustive audit coverage

- **F01** Contribution events mislabeled as commits → S02 #1297, S03 #1298, S05 #1300.
- **F02** Opened/repository-wide issues mislabeled as personal closures → S02 #1297, S04 #1299.
- **F03** Teammate history credited as personal work → S02 #1297.
- **F04** External contributed repositories omitted → S02 #1297, S05 #1300.
- **F05** Daily events substituted for ten-minute commit bursts → S06 #1301.
- **F06** Breadth weights total95%, unequal scale → S09 #1304.
- **F07** Docs-only scoring signal never collected → S06 #1301.
- **F08** Mean of medians is not pooled median → S06 #1301.
- **F09** Quality ratios weighted by wrong population → S06 #1301.
- **F10** Missing measurements and merge order change ratios → S06 #1301.
- **F11** Maximum source ratios mislabeled as pooled ratios → S06 #1301.
- **F12** Concentration merges incompatible units → S06 #1301.
- **F13** Cross-source event/repository overlaps double counted → S06 #1301, S07 #1302.
- **F14** GitHub merge window uses creation time → S02 #1297.
- **F15** Linked-provider event windows and timestamps inconsistent → S03 #1298, S04 #1299, S05 #1300.
- **F16** Supplemental annual totals never age out → S07 #1302, S19 #1314.
- **F17** Craft reports never age out/latest upload overwrites evidence → S10 #1305, S19 #1314.
- **F18** Legitimate direct-push/issue-only/empty profiles treated as corrupt → S08 #1303, S15 #1310.
- **F19** Final annual PR expiring to zero rejected → S08 #1303.
- **F20** Mixed-state sampled PRs falsely prove corruption → S08 #1303.
- **F21** Server token assumed universally private-inclusive → S08 #1303.
- **F22** Hard caps/samples treated as complete annual observations → S02 #1297, S03 #1298, S05 #1300.
- **F23** Provider failures/diff errors become valid partials/zeros → S03 #1298, S04 #1299, S08 #1303.
- **F24** Missing response time earns maximum credit → S10 #1305.
- **F25** Accepted overflow produces NaN/out-of-domain arithmetic → S10 #1305.
- **F26** Rounded EMA stalls; same-day feedback and missing-day policy → S13 #1308, S19 #1314.
- **F27** Ambient clocks prevent historical determinism → S01 #1296, S12 #1307, S15 #1310.
- **F28** Published normalization examples wrong → S17 #1312.
- **F29** Quality displayed breakdown omits actual formula path → S16 #1311, S17 #1312.
- **F30** LOC-never-scored claim false → S17 #1312.
- **F31** Headline smoothing and convergence claims false → S17 #1312.
- **F32** Solo Quality Champion eligibility copy conflicts with code → S16 #1311, S17 #1312.
- **F33** Solo/review-ratio denominator creates score cliff → S01 #1296, S09 #1304, S18 #1313.
- **F34** Optional Craft disclosure changes core scale and can lower score → S01 #1296, S09 #1304, S15 #1310, S16 #1311, S18 #1313.
- **F35** PR splitting and tiny-useful-change/LOC incentives → S09 #1304, S18 #1313.
- **F36** Missing attributable outcomes, quality, design, mentoring and maintenance → S11 #1306, S18 #1313.
- **F37** Craft volume/tool-style rewards overclaim mastery and quality → S10 #1305, S17 #1312, S18 #1313.
- **F38** Craft excellence/Artificer with zero observed effectiveness → S10 #1305, S18 #1313.
- **F39** Entropy evenness misrepresented as tool breadth/mastery → S10 #1305, S18 #1313.
- **F40** Confidence heuristic confuses evidence coverage with ability/probability → S01 #1296, S09 #1304, S17 #1312, S18 #1313.
- **F41** Self-report authentication confused with truth/attestation → S10 #1305, S11 #1306, S18 #1313.
- **F42** Tiny samples/classification uncertainty treated as reliable rates → S10 #1305, S11 #1306, S18 #1313.
- **F43** Unknown outcome labels/unclassified sessions/likely-satisfied semantics → S10 #1305, S18 #1313.
- **F44** Unsupported percentile calibration and research-derived claims → S17 #1312, S18 #1313.
- **F45** Snapshots/export lack versioned complete replay inputs → S12 #1307, S13 #1308, S14 #1309, S15 #1310, S19 #1314.
- **F46** Signed Craft lost in persisted verification record → S14 #1309, S19 #1314.
- **F47** HMAC/valid link overstated as source truth or SVG tamper detection → S14 #1309, S17 #1312.
- **F48** API mixes fresh score/stored dimensions; consumer/simulation drift → S12 #1307, S13 #1308, S15 #1310, S16 #1311, S19 #1314.
- **F49** Sparse/dense heatmaps change consistency → S06 #1301, S18 #1313.
- **F50** Tenure/role/private-work availability conflated with ability → S01 #1296, S09 #1304, S17 #1312, S18 #1313.
- **F51** Metadata presence/empty approvals/irrelevant CI are weak quality evidence → S09 #1304, S11 #1306, S18 #1313.
- **F52** Lifetime owner popularity mistaken for individual annual influence → S06 #1301, S09 #1304, S11 #1306, S18 #1313.
- **F53** Subdimension weight/rounding declarations and absent-vs-zero ambiguity → S10 #1305, S12 #1307, S16 #1311, S17 #1312.

## Final closure

S20 may complete only after every task and requirement has an implementation/validation artifact, the pilot and local transition rehearsal pass, and claims reconcile with receipts. A missing empirical prerequisite blocks relaunch; fixtures cannot replace it. Completing this epic does not authorize production release.
